...
import net.medox.neonengine.physics.DynamicCharacterController;
import net.medox.neonengine.physics.PhysicsEngine;
import net.medox.neonengine.rendering.Camera;

public class DynamicPlayerComponent extends EntityComponent{
	private Camera camera;
	
	private DynamicCharacterController controller;
	
	public DynamicPlayerComponent(Collider collider, Camera camera){
		controller = new DynamicCharacterController(collider, 0.3f);
...
//		controller.setMaxSlope((float)Math.toRadians(55));
	...
	public DynamicCharacterController getController(){
		return controller;
	}
	
	@Override
	public void update(float delta){
		getTransform().setPos(controller.getCollider().getPos());
	}
...
//		}
	...
	public void addToEngine(){
		PhysicsEngine.addCollider(controller.getCollider());
	}
	
	@Override
	public void cleanUp(){
		PhysicsEngine.removeCollider(controller.getCollider());
	}
}
