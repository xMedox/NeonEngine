...
//		pointConstraint = new Point2PointConstraint(cA.getBody(), cB.getBody(), new Vector3f(pivotInA.getX(), pivotInA.getY(), pivotInA.getZ()), new Vector3f(pivotInB.getX(), pivotInB.getY(), pivotInB.getZ()));
		...
		setConstraint(new Point2PointConstraint(cA.getBody(), new Vector3f(pivotInA.getX(), pivotInA.getY(), pivotInA.getZ())));
	}
...
//		pointConstraint = new Point2PointConstraint(cA.getBody(), cB.getBody(), new Vector3f(pivotInA.getX(), pivotInA.getY(), pivotInA.getZ()), new Vector3f(pivotInB.getX(), pivotInB.getY(), pivotInB.getZ()));
		...
		setConstraint(new Point2PointConstraint(cA.getBody(), cB.getBody(), new Vector3f(pivotInA.getX(), pivotInA.getY(), pivotInA.getZ()), new Vector3f(pivotInB.getX(), pivotInB.getY(), pivotInB.getZ())));
	}
